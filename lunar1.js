...
function getChineseDay() {
    ...
    var tt = '【' + Animals[(SY - 4) % 12] + '】'+cyclical(SY - 1900 + 36) + '年 ' +  cDay(lDObj.month, lDObj.day);
    return   tt;//(cl + tt + '</font>');
}
function solarDay2() {
    var sDObj = new Date(SY, SM, SD);
    var lDObj = new Lunar(sDObj);
...
//    return (cl + festival + '</font>');
     return {solarTerms:solarTerms, solarFestival:solarFestival,lunarFestival:lunarFestival};
}
